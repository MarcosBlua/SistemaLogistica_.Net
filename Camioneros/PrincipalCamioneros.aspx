<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PrincipalCamioneros.aspx.vb" Inherits="Camioneros_PrincipalCamioneros" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Button ID="Agregar" runat="server" Text="Agregar Nuevo Camionero" class="boton"/>
            
            <h1 style="margin-left: 30px;"> Camioneros contratados </h1>
            ...
            <div class="container-table">
                <table class ="table table-hover">
                    ...
                    <asp:Repeater ID="listado" runat="server">
                        <itemtemplate>
                            <tr>
                                <td><%# Container.DataItem("IdCamionero") %></td>
                                ...
                                <td><a href="ModCamionero.aspx?id=<%# Container.DataItem("IdCamionero") %>"><i class="fas fa-edit"></i></a></td>  
                                <td><a href="BajaCamionero.aspx?id=<%# Container.DataItem("IdCamionero") %>"><i class="fas fa-trash"></i></a></td> 
                            </tr>
                        </itemtemplate>
                   </asp:Repeater>
                </table>
