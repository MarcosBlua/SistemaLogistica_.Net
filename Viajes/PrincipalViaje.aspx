<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PrincipalViaje.aspx.vb" Inherits="Viajes_PrincipalViaje" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Button ID="Agregar" runat="server" Text="Crear Nuevo Viaje" class="boton"/>
            
            <h1 style="margin-left: 30px;"> Viajes Activos </h1>
                    ...
                    <asp:Repeater ID="listado" runat="server">
                        <itemtemplate>
                            <tr>
                                ...
                                <td><a href="ModViaje.aspx?id=<%# Container.DataItem("IdViaje") %>"><i class="fas fa-edit"></i></a></td>  
                                <td><a href="BajaViaje.aspx?id=<%# Container.DataItem("IdViaje") %>"><i class="fas fa-trash"></i></a></td> 
                            </tr>
                        </itemtemplate>
                    </asp:Repeater>
                </table>
