    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Else
                ...
                comando = New SqlCommand("SELECT * FROM Viaje WHERE IdViaje = @id and Baja = 0", conexion)
                ...
                If lector.Read() Then
                    DDProvincias.SelectedValue = lector("IdProvinciaDestino")
                    DDProvincias_SelectedIndexChanged(DDProvincias, e)
                    DDCiudades.SelectedValue = lector("IdCiudadDestino")
                    DDCamiones.SelectedValue = lector("IdCamion")
                    DDCamioneros.SelectedValue = lector("IdCamionero")
    ...
    Private Sub Guardar_Click(sender As Object, e As EventArgs) Handles Guardar.Click
        ...
        Else
            If Page.IsValid Then
                ...
                conexion.Open()
                comando = New SqlCommand("UPDATE Viaje SET IdProvinciaDestino = @Prov, IdCiudadDestino = @Ciud, IdCamion = @Camion, IdCamionero = @Camionero, Estado = @Est, Baja = @Baja WHERE IdViaje = @id", conexion)
