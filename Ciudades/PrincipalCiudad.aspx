<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PrincipalCiudad.aspx.vb" Inherits="Ciudades_PrincipalCiudad" %>
...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light sticky-top">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="navbar-nav mr-auto mx-auto mt-2 mt-md-0">
                ...
                <li class="nav-item activa"><a class="nav-link" href="/Ciudades/PrincipalCiudad.aspx">Cuidades Soportadas</a></li>
			</ul>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Button ID="Agregar" runat="server" Text="Agregar Nueva Ciudad" class="boton"/>

            <asp:Button ID="Provincias" runat="server" Text="Ver Provincias Trabajadas" class="boton"/>
            
            <h1 style="margin-left: 30px;"> Ciudades que se trabajan </h1>
                    ...
                    <asp:Repeater ID="listado" runat="server">
                        <itemtemplate>
                            <tr>
                                ...
                                <td><%# Container.DataItem("Ciudad") %></td>
                                <td><%# Container.DataItem("Provincia") %></td>
                                <td><a href="ModCiudad.aspx?id=<%# Container.DataItem("IdCiudad") %>"><i class="fas fa-edit"></i></a></td>  
                                <td><a href="BajaCiudad.aspx?id=<%# Container.DataItem("IdCiudad") %>"><i class="fas fa-trash"></i></a></td> 
                            </tr>
                        </itemtemplate>
                    </asp:Repeater>
                </table>
