<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AltaCiudad.aspx.vb" Inherits="Ciudades_AltaCiudad" %>
            ...
            <table class ="table table-hover">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage=" *Requerido" ControlToValidate="Ciudad" ForeColor="red"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage=" *Requerido" ControlToValidate="DDProvincias" ForeColor="red"></asp:RequiredFieldValidator>
                    </td>
                </tr>
            </table>
            
            <asp:Button ID="Guardar" runat="server" Text="Guardar Nueva Ciudad" class="boton"/>
