<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PrincipalCliente.aspx.vb" Inherits="Clientes_PrincipalCliente" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Button ID="Agregar" runat="server" Text="Agregar Nuevo Cliente" class="boton"/>
            
            <h1 style="margin-left: 30px;"> Lista de clientes </h1>
                    ...
                    <asp:Repeater ID="listado" runat="server">
                        <itemtemplate>
                            <tr>
                                ...
                                <td><%# Container.DataItem("Cuit") %></td>
                                <td><%# Container.DataItem("Provincia") %></td>
                                <td><%# Container.DataItem("Ciudad") %></td>
                                <td><a href="ModCliente.aspx?id=<%# Container.DataItem("IdCliente") %>"><i class="fas fa-edit"></i></a></td>  
                                <td><a href="BajaCliente.aspx?id=<%# Container.DataItem("IdCliente") %>"><i class="fas fa-trash"></i></a></td> 
                            </tr>
                        </itemtemplate>
                    </asp:Repeater>
                </table>
