<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Reporte 4.aspx.vb" Inherits="Reporte_4" %>
...
<body>
	...
	<div class="container" style="text-align: center;">
		...
		<h1>Cantidad de viajes a cuidades por provincias</h1>

		<br />
		<form id="form1" runat="server">
			Provincia <asp:DropDownList ID="DDProvincia" runat="server" style="margin-left:70px;" AutoPostBack="true"></asp:DropDownList>
		</form>

		<br />
		<br />

		<asp:Chart ID="Chart1" runat="server" Height="552px" Width="627px">
			<Series>
