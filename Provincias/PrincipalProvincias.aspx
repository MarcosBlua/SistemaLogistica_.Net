<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PrincipalProvincias.aspx.vb" Inherits="Provincias_PrincipalProvincias" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Button ID="Agregar" runat="server" Text="Agregar Nueva Provicia Trabajada" class="boton"/>
            
            <h1 style="margin-left: 30px;"> Provincias que se trabajan </h1>
                    ...
                    <asp:Repeater ID="listado" runat="server">
                        <itemtemplate>
                            <tr>
                                ...
                                <td><a href="ModProvincia.aspx?id=<%# Container.DataItem("IdProvincia") %>"><i class="fas fa-edit"></i></a></td>  
                                <td><a href="BajaProvincia.aspx?id=<%# Container.DataItem("IdProvincia") %>"><i class="fas fa-trash"></i></a></td> 
                            </tr>
                        </itemtemplate>
                    </asp:Repeater>
                </table>
