<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AltaProvincia.aspx.vb" Inherits="Provincias_AltaProvincia" %>
            ...
            <table class ="table table-hover">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage=" *Requerido" ControlToValidate="Provincia" ForeColor="red"></asp:RequiredFieldValidator>
                    </td>
                </tr>
            </table>
