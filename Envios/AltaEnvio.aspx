<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AltaEnvio.aspx.vb" Inherits="Envios_AltaEnvio" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <table class ="table table-hover">              
                <tr>
                    <td>Número de viaje en el cual se mandara el envio</td>
                    <td>
                        <asp:DropDownList ID="DDViajes" runat="server"></asp:DropDownList>
                        <asp:CustomValidator ID="ViajesValidator" runat="server" ErrorMessage=" *Requerido" ControlToValidate="DDViajes" ForeColor="red" OnServerValidate="ViajesValidator_ServerValidate"></asp:CustomValidator>
                    </td>
                </tr>
                <tr>
                    <td>Cliente</td>
                    <td>
                        ...
                        <asp:CustomValidator ID="ClientesValidator" runat="server" ErrorMessage=" *Requerido" ControlToValidate="DDClientes" ForeColor="red" OnServerValidate="ClientesValidator_ServerValidate"></asp:CustomValidator>
                    </td>
                </tr>
                <tr>
                    <td>Estado del envio</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage=" *Requerido" ControlToValidate="Des" ForeColor="red"></asp:RequiredFieldValidator>
                    </td>
                </tr>                                    
            </table>
